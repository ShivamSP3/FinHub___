    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        mainAxisAlignment: MainAxisAlignment.center,
          ...
          buttonItem("assets/google1.svg","Continue with Google",25,()async{
            await AuthClass().googleSignIn(context);
          }),
          SizedBox(
            height: 15,
          ),
           buttonItem("assets/phone1.svg","Continue with Mobile",25,(){}),
            SizedBox(
              height: 20,
            ),
  ...
  Widget colorButton(){
    ...
    width: MediaQuery.of(context).size.width-90,
                ...
                decoration: BoxDecoration(
                 ...
                 child: Center(
                  child: circular?CircularProgressIndicator(): Text("Sign Up ",style: TextStyle(
